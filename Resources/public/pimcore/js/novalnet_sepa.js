...
pimcore.registerNS('coreshop.provider.gateways.novalnet_sepa');
coreshop.provider.gateways.novalnet_sepa = Class.create(coreshop.provider.gateways.abstract, {
    getLayout: function (config) {
        ...
        return [
            ...
            },
            {
                ...
                listeners: {
                    change: function(component) {
                        var minAmountField = Ext.getCmp('novalnet_sepa_min_authorize_amount');
            ...
            },
            {
                ...
                id: 'novalnet_sepa_min_authorize_amount',
                listeners: {
                    afterrender: function (component) {
