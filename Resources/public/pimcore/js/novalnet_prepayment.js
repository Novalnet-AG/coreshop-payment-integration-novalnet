...
pimcore.registerNS('coreshop.provider.gateways.novalnet_prepayment');
coreshop.provider.gateways.novalnet_prepayment = Class.create(coreshop.provider.gateways.abstract, {
    getLayout: function (config) {
        ...
        return [
            ...
            },
            {
                ...
                listeners: {
                    afterrender: function (component) {
                        self.createTooltip(component, t('novalnet.prepayment.duedays.tooltip'));
                    }
                }
            },
            {
