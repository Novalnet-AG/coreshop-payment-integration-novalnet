...
pimcore.registerNS('coreshop.provider.gateways.novalnet_paypal');
coreshop.provider.gateways.novalnet_paypal = Class.create(coreshop.provider.gateways.abstract, {
        ...
        return [
            {
                xtype: 'label',
                anchor: '100%',
                html: t('novalnet.paypal.info.text')
            },
            {
                xtype: 'combobox',
            ...
            },
            {
                ...
                listeners: {
                    change: function(component) {
                        var minAmountField = Ext.getCmp('novalnet_paypal_min_authorize_amount');
            ...
            },
            {
                ...
                id: 'novalnet_paypal_min_authorize_amount',
                listeners: {
                    afterrender: function (component) {
