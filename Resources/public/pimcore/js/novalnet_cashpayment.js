...
pimcore.registerNS('coreshop.provider.gateways.novalnet_cashpayment');
coreshop.provider.gateways.novalnet_cashpayment = Class.create(coreshop.provider.gateways.abstract, {
    getLayout: function (config) {
        ...
        return [
            ...
            {
                xtype: 'textfield',
                fieldLabel: t('novalnet.cashpayment.duedays.label'),
                labelStyle: 'font-weight: 600;',
                ...
                listeners: {
                    afterrender: function (component) {
                        self.createTooltip(component, t('novalnet.cashpayment.duedays.tooltip'));
                    }
                }
            },
            {
