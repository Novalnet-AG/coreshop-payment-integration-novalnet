 ...
 */
pimcore.registerNS('coreshop.provider.gateways.novalnet_invoice');
coreshop.provider.gateways.novalnet_invoice = Class.create(coreshop.provider.gateways.abstract, {
    getLayout: function (config) {
        ...
        return [
            ...
            },
            {
                ...
                listeners: {
                    afterrender: function (component) {
                        self.createTooltip(component, t('novalnet.invocie.duedays.tooltip'));
                    }
                }
            },
            {
                ...
                listeners: {
                    change: function(component) {
                        var minAmountField = Ext.getCmp('novalnet_invoice_min_authorize_amount');
            ...
            },
            {
                ...
                id: 'novalnet_invoice_min_authorize_amount',
                listeners: {
                    afterrender: function (component) {
            ...
            {
                xtype: 'combobox',
                fieldLabel: t('novalnet.webhook.status.label'),
                labelStyle: 'font-weight: 600;',
                name: 'gatewayConfig.config.webhook_status',
                value: config.webhook_status ? config.webhook_status : 'captured',
                store: self.getStatusStore(),
                triggerAction: 'all',
                valueField: 'value',
                displayField: 'label',
                ...
                listeners: {
                    afterrender: function (component) {
                        self.createTooltip(component, t('novalnet.webhook.status.tooltip'));
                    }
                }
            },
        ];
