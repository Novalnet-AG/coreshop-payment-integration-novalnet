...
pimcore.registerNS('coreshop.provider.gateways.novalnet_invoice_guarantee');
coreshop.provider.gateways.novalnet_invoice_guarantee = Class.create(coreshop.provider.gateways.abstract, {
    getLayout: function (config) {
        ...
        return [
            ...
            },
            {
                ...
                listeners: {
                    change: function(component) {
                        var minAmountField = Ext.getCmp('novalnet_invoiceguarantee_min_authorize_amount');
            ...
            },
            {
                ...
                id: 'novalnet_invoiceguarantee_min_authorize_amount',
                listeners: {
                    afterrender: function (component) {
