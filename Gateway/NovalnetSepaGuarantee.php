...
class NovalnetSepaGuarantee extends NovalnetGatewayFactory
{
    /**
     * {@inheritDoc}
     */
    protected function populateConfig(ArrayObject $config)
    {
        $config->defaults(
            [
                'payum.factory_name' => Constants::NOVALNET_SEPA_GUARANTEE,
                'payum.factory_title' => Constants::NOVALNET_SEPA_GUARANTEE,
                'payum.template.obtain_token' => '@PayumNovalnet/Action/novalnet_sepa_guarantee.html.twig',
