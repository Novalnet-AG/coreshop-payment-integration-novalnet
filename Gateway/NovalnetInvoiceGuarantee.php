...
class NovalnetInvoiceGuarantee extends NovalnetGatewayFactory
{
    /**
     * {@inheritDoc}
     */
    protected function populateConfig(ArrayObject $config)
    {
        $config->defaults(
            [
                'payum.factory_name' => Constants::NOVALNET_INVOICE_GUARANTEE,
                'payum.factory_title' => Constants::NOVALNET_INVOICE_GUARANTEE,
                'payum.template.obtain_token' => '@PayumNovalnet/Action/novalnet_invoice_guarantee.html.twig',
