...
class NovalnetPrepayment extends NovalnetGatewayFactory
{
    /**
     * {@inheritDoc}
     */
    protected function populateConfig(ArrayObject $config)
    {
        $config->defaults(
            [
                'payum.factory_name' => Constants::NOVALNET_PREPAYMENT,
                'payum.factory_title' => Constants::NOVALNET_PREPAYMENT,
            ]
        );
