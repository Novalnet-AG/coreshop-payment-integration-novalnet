...
class NovalnetBancontact extends NovalnetGatewayFactory
{
    /**
     * {@inheritDoc}
     */
    protected function populateConfig(ArrayObject $config)
    {
        $config->defaults(
            [
            'payum.factory_name' => Constants::NOVALNET_BANCONTACT,
            'payum.factory_title' => Constants::NOVALNET_BANCONTACT,
            ]
        );
